...
l||D)p._creditLink.setAttribute("href",p.creditHref),p._creditLink.innerHTML=p.creditText;p._creditLink&&p.creditHref&&p.creditText?(p._creditLink.parentElement||p._canvasJSContainer.appendChild(p._creditLink),p._creditLink.style.top=p.height-14+"px"):p._creditLink.parentElement&&p._canvasJSContainer.removeChild(p._creditLink)}}}function ra(p,l){Ia&&(this.canvasCount|=0,window.console.log(++this.canvasCount));var D=document.createElement("canvas");D.setAttribute("class","canvasjs-chart-canvas");Na(D,
p,l);s||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(D);return D}function qa(p,l,D){for(var s in D)l.style[s]=D[s]}function sa(p,l,D){l.getAttribute("state")||(l.style.backgroundColor=p.toolbar.backgroundColor,l.style.color=p.toolbar.fontColor,l.style.border="none",qa(p,l,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));l.getAttribute("state")!==D&&(l.setAttribute("state",D),l.setAttribute("type","button"),qa(p,l,{padding:"5px 12px",
cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),l.setAttribute("title",p._cultureInfo[D+"Text"]),l.innerHTML="<img style='height:95%; pointer-events: none;' src='"+jb[D].image+"' alt='"+p._cultureInfo[D+"Text"]+"' />")}function Pa(){for(var p=null,l=0;l<arguments.length;l++)p=arguments[l],p.style&&(p.style.display="inline")}function ta(){for(var p=null,l=0;l<arguments.length;l++)(p=arguments[l])&&p.style&&(p.style.display="none")}
function W(p,l,D,s,w){this._defaultsKey=p;this._themeOptionsKey=l;this._index=s;this.parent=w;this._eventListeners=[];p={};this.theme&&v(l)&&v(s)?p=v(xa[this.theme])?xa.light1:xa[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[l])&&(null===s?p=this.parent.themeOptions[l]:0<this.parent.themeOptions[l].length&&(s=Math.min(this.parent.themeOptions[l].length-1,s),p=this.parent.themeOptions[l][s]));this.themeOptions=p;this.options=D?D:{_isPlaceholder:!0};this.setOptions(this.options,
p)}function Fa(p,l,s,v,w){"undefined"===typeof w&&(w=0);this._padding=w;this._x1=p;this._y1=l;this._x2=s;this._y2=v;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ja(p,l){ja.base.constructor.call(this,"TextBlock",null,l,null,null);this.ctx=p;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ua(p,l){Ua.base.constructor.call(this,"Toolbar","toolbar",l,null,p);this.chart=p;this.canvas=p.canvas;this.ctx=this.chart.ctx;this.optionsName=
"toolbar"}function za(p,l){za.base.constructor.call(this,"Title","title",l,null,p);this.chart=p;this.canvas=p.canvas;this.ctx=this.chart.ctx;this.optionsName="title";if(v(this.options.margin)&&p.options.subtitles)for(var s=p.options.subtitles,ya=0;ya<s.length;ya++)if((v(s[ya].horizontalAlign)&&"center"===this.horizontalAlign||s[ya].horizontalAlign===this.horizontalAlign)&&(v(s[ya].verticalAlign)&&"top"===this.verticalAlign||s[ya].verticalAlign===this.verticalAlign)&&!s[ya].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=
...
this.bounds={x1:null,y1:null,x2:null,y2:null}}function Va(){this.pool=[]}function Ka(p){var l;p&&La[p]&&(l=La[p]);Ka.base.constructor.call(this,"CultureInfo",null,l,null,null)}var Ia=!1,U={},s=!!document.createElement("canvas").getContext,pa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",
...
fnt:"gnou",fSy:"ghmmRuxmd",fTx:"ghmmUdyu",grClr:"fsdx",cntx:"buy",tp:"unq"};delete pa[U.fSDec("Bi`su")][U.fSDec("bsdehuIsdg")];U.pro={sCH:pa[U.fSDec("Bi`su")][U.fSDec("bsdehuIsdg")]};U._fTWm=function(p){if("undefined"===typeof U.pro.sCH&&!cb)try{var l=p[U.fSDec(U.obj.cntx)];l[U.fSDec(U.obj.txtBl)]=U.fSDec(U.obj.tp);l[U.fSDec(U.obj.fnt)]=11+U.fSDec(U.obj.fntStr);l[U.fSDec(U.obj.fSy)]=U.fSDec(U.obj.grClr);l[U.fSDec(U.obj.fTx)](U.fSDec(U.obj.trVs),2,p.height-11-2)}catch(s){}}})();var Za={},wa=null,kb=
function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},lb=function(p,l,s){l=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=l?12:10,Math.round(l*(p/400)))},Ba=function(){var p=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,l="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),s="Sun Mon Tue Wed Thu Fri Sat".split(" "),
v="January February March April May June July August September October November December".split(" "),w="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),J=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,F=/[^-+\dA-Z]/g;return function(C,G,N){var R=N?N.days:l,K=N?N.months:v,S=N?N.shortDays:s,O=N?N.shortMonths:w;N="";var T=!1;C=C&&C.getTime?C:C?new Date(C):new Date;if(isNaN(C))throw SyntaxError("invalid date");
"UTC:"===G.slice(0,4)&&(G=G.slice(4),T=!0);N=T?"getUTC":"get";var U=C[N+"Date"](),W=C[N+"Day"](),M=C[N+"Month"](),L=C[N+"FullYear"](),a=C[N+"Hours"](),d=C[N+"Minutes"](),b=C[N+"Seconds"](),c=C[N+"Milliseconds"](),e=T?0:C.getTimezoneOffset();return N=G.replace(p,function(g){switch(g){case "D":return U;case "DD":return $(U,2);case "DDD":return S[W];case "DDDD":return R[W];case "M":return M+1;case "MM":return $(M+1,2);case "MMM":return O[M];case "MMMM":return K[M];case "Y":return parseInt(String(L).slice(-2));
case "YY":return $(String(L).slice(-2),2);case "YYY":return $(String(L).slice(-3),3);case "YYYY":return $(L,4);case "h":return a%12||12;case "hh":return $(a%12||12,2);case "H":return a;case "HH":return $(a,2);case "m":return d;case "mm":return $(d,2);case "s":return b;case "ss":return $(b,2);case "f":return String(c).slice(0,1);case "ff":return $(String(c).slice(0,2),2);case "fff":return $(String(c).slice(0,3),3);case "t":return 12>a?"a":"p";case "tt":return 12>a?"am":"pm";case "T":return 12>a?"A":
"P";case "TT":return 12>a?"AM":"PM";case "K":return T?"UTC":(String(C).match(J)||[""]).pop().replace(F,"");case "z":return(0<e?"-":"+")+Math.floor(Math.abs(e)/60);case "zz":return(0<e?"-":"+")+$(Math.floor(Math.abs(e)/60),2);case "zzz":return(0<e?"-":"+")+$(Math.floor(Math.abs(e)/60),2)+$(Math.abs(e)%60,2);default:return g.slice(1,g.length-1)}})}}(),ga=function(p,l,s){if(null===p)return"";if(!isFinite(p))return p;p=Number(p);var v=0>p?!0:!1;v&&(p*=-1);var w=s?s.decimalSeparator:".",J=s?s.digitGroupSeparator:
",",F="";l=String(l);var F=1,C=s="",G=-1,N=[],R=[],K=0,S=0,T=0,O=!1,U=0,C=l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);l=null;for(var L=0;C&&L<C.length;L++)if(l=C[L],"."===l&&0>G)G=L;else{if("%"===l)F*=100;else if("\u2030"===l){F*=1E3;continue}else if(","===l[0]&&"."===l[l.length-1]){F/=Math.pow(1E3,l.length-1);G=L+l.length-1;continue}else"E"!==l[0]&&"e"!==l[0]||"0"!==l[l.length-1]||(O=!0);0>G?(N.push(l),"#"===l||"0"===l?K++:","===l&&T++):(R.push(l),"#"!==l&&"0"!==l||S++)}O&&(l=Math.floor(p),
C=-Math.floor(Math.log(p)/Math.LN10+1),U=0===p?0:0===l?-(K+C):String(l).length-K,F/=Math.pow(10,U));0>G&&(G=L);F=(p*F).toFixed(S);l=F.split(".");F=(l[0]+"").split("");p=(l[1]+"").split("");F&&"0"===F[0]&&F.shift();for(O=C=L=S=G=0;0<N.length;)if(l=N.pop(),"#"===l||"0"===l)if(G++,G===K){var M=F,F=[];if("0"===l)for(l=K-S-(M?M.length:0);0<l;)M.unshift("0"),l--;for(;0<M.length;)s=M.pop()+s,O++,0===O%C&&(L===T&&0<M.length)&&(s=J+s)}else 0<F.length?(s=F.pop()+s,S++,O++):"0"===l&&(s="0"+s,S++,O++),0===O%
C&&(L===T&&0<F.length)&&(s=J+s);else"E"!==l[0]&&"e"!==l[0]||"0"!==l[l.length-1]||!/[eE][+-]*[0]+/.test(l)?","===l?(L++,C=O,O=0,0<F.length&&(s=J+s)):s=1<l.length&&('"'===l[0]&&'"'===l[l.length-1]||"'"===l[0]&&"'"===l[l.length-1])?l.slice(1,l.length-1)+s:l+s:(l=0>U?l.replace("+","").replace("-",""):l.replace("-",""),s+=l.replace(/[0]+/,function(p){return $(U,p.length)}));J="";for(N=!1;0<R.length;)l=R.shift(),"#"===l||"0"===l?0<p.length&&0!==Number(p.join(""))?(J+=p.shift(),N=!0):"0"===l&&(J+="0",N=
!0):1<l.length&&('"'===l[0]&&'"'===l[l.length-1]||"'"===l[0]&&"'"===l[l.length-1])?J+=l.slice(1,l.length-1):"E"!==l[0]&&"e"!==l[0]||"0"!==l[l.length-1]||!/[eE][+-]*[0]+/.test(l)?J+=l:(l=0>U?l.replace("+","").replace("-",""):l.replace("-",""),J+=l.replace(/[0]+/,function(p){return $(U,p.length)}));s+=(N?w:"")+J;return v?"-"+s:s},Qa=function(p){var l=0,s=0;p=p||window.event;p.offsetX||0===p.offsetX?(l=p.offsetX,s=p.offsetY):p.layerX||0==p.layerX?(l=p.layerX,s=p.layerY):(l=p.pageX-p.target.offsetLeft,
s=p.pageY-p.target.offsetTop);return{x:l,y:s}},ab=!0,Ta=window.devicePixelRatio||1,Oa=1,ha=ab?Ta/Oa:1,X=function(p,l,s,v,w,J,F,C,G,N,R,S,O){"undefined"===typeof O&&(O=1);F=F||0;C=C||"black";var K=15<v-l&&15<w-s?8:0.35*Math.min(v-l,w-s);p.beginPath();p.moveTo(l,s);p.save();p.fillStyle=J;p.globalAlpha=O;p.fillRect(l,s,v-l,w-s);p.globalAlpha=1;0<F&&(O=0===F%2?0:0.5,p.beginPath(),p.lineWidth=F,p.strokeStyle=C,p.moveTo(l,s),p.rect(l-O,s-O,v-l+2*O,w-s+2*O),p.stroke());p.restore();!0===G&&(p.save(),p.beginPath(),
p.moveTo(l,s),p.lineTo(l+K,s+K),p.lineTo(v-K,s+K),p.lineTo(v,s),p.closePath(),F=p.createLinearGradient((v+l)/2,s+K,(v+l)/2,s),F.addColorStop(0,J),F.addColorStop(1,"rgba(255, 255, 255, .4)"),p.fillStyle=F,p.fill(),p.restore());!0===N&&(p.save(),p.beginPath(),p.moveTo(l,w),p.lineTo(l+K,w-K),p.lineTo(v-K,w-K),p.lineTo(v,w),p.closePath(),F=p.createLinearGradient((v+l)/2,w-K,(v+l)/2,w),F.addColorStop(0,J),F.addColorStop(1,"rgba(255, 255, 255, .4)"),p.fillStyle=F,p.fill(),p.restore());!0===R&&(p.save(),
p.beginPath(),p.moveTo(l,s),p.lineTo(l+K,s+K),p.lineTo(l+K,w-K),p.lineTo(l,w),p.closePath(),F=p.createLinearGradient(l+K,(w+s)/2,l,(w+s)/2),F.addColorStop(0,J),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),p.fillStyle=F,p.fill(),p.restore());!0===S&&(p.save(),p.beginPath(),p.moveTo(v,s),p.lineTo(v-K,s+K),p.lineTo(v-K,w-K),p.lineTo(v,w),F=p.createLinearGradient(v-K,(w+s)/2,v,(w+s)/2),F.addColorStop(0,J),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),p.fillStyle=F,F.addColorStop(0,J),F.addColorStop(1,
"rgba(255, 255, 255, 0.1)"),p.fillStyle=F,p.fill(),p.closePath(),p.restore())},Y=function(p){for(var l="",s=0;s<p.length;s++)l+=String.fromCharCode(Math.ceil(p.length/57/5)^p.charCodeAt(s));return l},cb=window&&window[Y("mnb`uhno")]&&window[Y("mnb`uhno")].href&&window[Y("mnb`uhno")].href.indexOf&&(-1!==window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl"))||-1!==window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl"))||-1!==window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))),ib=cb&&-1===window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),
...
(this.options._oldOptions={});return this.options._oldOptions[p]?!0:!1};W.prototype.hasOptionChanged=function(p){if(!this.sessionVariables)throw"Session Variable Store not set";return this.sessionVariables[p]!==this.options[p]};W.prototype.addEventListener=function(p,l,s){p&&l&&(this._eventListeners[p]=this._eventListeners[p]||[],this._eventListeners[p].push({context:s||this,eventHandler:l}))};W.prototype.removeEventListener=function(p,l){if(p&&l&&this._eventListeners[p])for(var s=this._eventListeners[p],
v=0;v<s.length;v++)if(s[v].eventHandler===l){s[v].splice(v,1);break}};W.prototype.removeAllEventListeners=function(){this._eventListeners=[]};W.prototype.dispatchEvent=function(p,l,s){if(p&&this._eventListeners[p]){l=l||{};for(var v=this._eventListeners[p],w=0;w<v.length;w++)v[w].eventHandler.call(v[w].context,l)}"function"===typeof this[p]&&this[p].call(s||this.chart,l)};Fa.prototype.registerSpace=function(p,l){"top"===p?this._topOccupied+=l.height:"bottom"===p?this._bottomOccupied+=l.height:"left"===
p?this._leftOccupied+=l.width:"right"===p&&(this._rightOccupied+=l.width)};Fa.prototype.unRegisterSpace=function(p,l){"top"===p?this._topOccupied-=l.height:"bottom"===p?this._bottomOccupied-=l.height:"left"===p?this._leftOccupied-=l.width:"right"===p&&(this._rightOccupied-=l.width)};Fa.prototype.getFreeSpace=function(){return{x1:this._x1+this._leftOccupied,y1:this._y1+this._topOccupied,x2:this._x2-this._rightOccupied,y2:this._y2-this._bottomOccupied,width:this._x2-this._x1-this._rightOccupied-this._leftOccupied,
...
0,this.bottomPadding=v(this.padding.bottom)?0:Number(this.padding.bottom)|0,this.leftPadding=v(this.padding.left)?0:Number(this.padding.left)|0)};ja.prototype.render=function(p){if(0!==this.fontSize){p&&this.ctx.save();var l=this.ctx.font;this.ctx.textBaseline=this.textBaseline;var s=0;this._isDirty&&this.measureText(this.ctx);this.ctx.translate(this.x,this.y+s);"middle"===this.textBaseline&&(s=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var v=
...
this._isDirty=!1;return{width:this.width,height:this.height}};ja.prototype._getLineWithWidth=function(p,l,s){p=String(p);if(!p)return{text:"",width:0};var v=s=0,w=p.length-1,J=Infinity;for(this.ctx.font=this._getFontString();v<=w;){var J=Math.floor((v+w)/2),F=p.substr(0,J+1);s=this.ctx.measureText(F).width;if(s<l)v=J+1;else if(s>l)w=J-1;else break}s>l&&1<F.length&&(F=F.substr(0,F.length-1),s=this.ctx.measureText(F).width);l=!0;if(F.length===p.length||" "===p[F.length])l=!1;l&&(p=F.split(" "),1<p.length&&
p.pop(),F=p.join(" "),s=this.ctx.measureText(F).width);return{text:F,width:s}};ja.prototype._wrapText=function(){var p=new String(Ha(String(this.text))),l=[],s=this.ctx.font,v=0,w=0;this.ctx.font=this._getFontString();if(0===this.frontSize)w=v=0;else for(;0<p.length;){var J=this.maxHeight-(this.topPadding+this.bottomPadding),F=this._getLineWithWidth(p,this.maxWidth-(this.leftPadding+this.rightPadding),!1);F.height=this._lineHeight;l.push(F);var C=w,w=Math.max(w,F.width),v=v+F.height,p=Ha(p.slice(F.text.length,
p.length));J&&v>J&&(F=l.pop(),v-=F.height,w=C)}this._wrappedText={lines:l,width:w,height:v};this.width=w+(this.leftPadding+this.rightPadding);this.height=v+(this.topPadding+this.bottomPadding);this.ctx.font=s};ja.prototype._getFontString=function(){var p;p=""+(this.fontStyle?this.fontStyle+" ":"");p+=this.fontWeight?this.fontWeight+" ":"";p+=this.fontSize?this.fontSize+"px ":"";var l=this.fontFamily?this.fontFamily+"":"";!s&&l&&(l=l.split(",")[0],"'"!==l[0]&&'"'!==l[0]&&(l="'"+l+"'"));return p+=l};
oa(Ua,W);oa(za,W);za.prototype.setLayout=function(){if(this.text){var p=this.dockInsidePlotArea?this.chart.plotArea:this.chart,l=p.layoutManager.getFreeSpace(),s=l.x1,w=l.y1,G=0,J=0,F=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,C,K;"top"===this.verticalAlign||"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=l.width-4-F*("center"===this.horizontalAlign?2:1)),J=0.5*l.height-this.margin-2,G=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||
"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=l.height-4),J=0.5*l.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=l.width-4),J=0.5*l.height-4));var N;v(this.padding)||"number"!==typeof this.padding?v(this.padding)||"object"!==typeof this.padding||(N=this.padding.top?this.padding.top:this.padding.bottom?this.padding.bottom:0,N+=this.padding.bottom?this.padding.bottom:this.padding.top?this.padding.top:0,N*=1.25):N=2.5*this.padding;this.wrap||
...
0,d=null;if(this.options.data){for(var b=0;b<this.options.data.length;b++)if(a++,!this.options.data[b].type||0<=l._supportedChartTypes.indexOf(this.options.data[b].type)){var c=new F(this,this.options.data[b],a-1,++this._eventManager.lastObjectId);"error"===c.type&&(c.linkedDataSeriesIndex=v(this.options.data[b].linkedDataSeriesIndex)?b-1:this.options.data[b].linkedDataSeriesIndex,0>c.linkedDataSeriesIndex||c.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof c.linkedDataSeriesIndex||
...
if(g&&window.console){window.console.log(g);return}}for(b=0;b<this.data.length;b++){if("none"==d&&"error"===this.data[b].type&&window.console){window.console.log('You cannot combine "'+c.type+'" with error chart');return}"error"===this.data[b].type&&(this.data[b].axisPlacement=this.plotInfo.axisPlacement=d||"normal",this.data[b]._linkedSeries=null===this.data[b].linkedDataSeriesIndex?null:this.data[this.data[b].linkedDataSeriesIndex])}}this._objectsInitialized=!0;this._plotAreaElements=[]};l._supportedChartTypes=
Ea("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeBar rangeArea rangeSplineArea pie doughnut funnel pyramid waterfall".split(" "));l.prototype.setLayout=function(){for(var a=this._plotAreaElements,d=0;d<this.data.length;d++)if("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement){if(!this.data[d].axisYType||
...
l.prototype.renderElements=function(){var a=this._plotAreaElements;this.title&&!this.title.dockInsidePlotArea&&this.title.render();for(var d=0;d<this.subtitles.length;d++)this.subtitles[d].dockInsidePlotArea||this.subtitles[d].render();this.legend.dockInsidePlotArea||this.legend.render();if("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)C.render(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement);else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();
...
1]);this._axes[m].scaleBreaks._appliedBreaks.sort(function(a,c){return a.startValue-c.startValue})}}};l.prototype.getDataPointAtXY=function(a,d,b){b=b||!1;for(var c=[],e=this._dataInRenderedOrder.length-1;0<=e;e--){var g=null;(g=this._dataInRenderedOrder[e].getDataPointAtXY(a,d,b))&&c.push(g)}a=null;d=!1;for(b=0;b<c.length;b++)if("line"===c[b].dataSeries.type||"stepLine"===c[b].dataSeries.type||"area"===c[b].dataSeries.type||"stepArea"===c[b].dataSeries.type)if(e=la("markerSize",c[b].dataPoint,c[b].dataSeries)||
8,c[b].distance<=e/2){d=!0;break}for(b=0;b<c.length;b++)d&&"line"!==c[b].dataSeries.type&&"stepLine"!==c[b].dataSeries.type&&"area"!==c[b].dataSeries.type&&"stepArea"!==c[b].dataSeries.type||(a?c[b].distance<=a.distance&&(a=c[b]):a=c[b]);return a};l.prototype.getObjectAtXY=function(a,d,b){var c=null;if(b=this.getDataPointAtXY(a,d,b||!1))c=b.dataSeries.dataPointIds[b.dataPointIndex];else if(s)c=$a(a,d,this._eventManager.ghostCtx);else for(b=0;b<this.legend.items.length;b++){var e=this.legend.items[b];
a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(c=e.id)}return c};l.prototype.getAutoFontSize=lb;l.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};l.prototype.clearCanvas=kb;l.prototype.attachEvent=function(a){this._events.push(a)};l.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],b=a.changedTouches,c=b?b[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=
...
window.console&&(window.console.log(b+" --\x3e x: "+d.x+"; y:"+d.y),e&&window.console.log(a.which),"mouseup"===b&&window.console.log("mouseup")),!e){if(!l.capturedEventParam&&this._events){for(var g=0;g<this._events.length;g++)if(this._events[g].hasOwnProperty(b))if(c=this._events[g],e=c.bounds,d.x>=e.x1&&d.x<=e.x2&&d.y>=e.y1&&d.y<=e.y2){c[b].call(c.context,d.x,d.y);"mousedown"===b&&!0===c.capture?(l.capturedEventParam=c,this.overlaidCanvas.setCapture?this.overlaidCanvas.setCapture():document.documentElement.addEventListener("mouseup",
...
this.axisX2.length;e++)this.axisX2[e].crosshair&&this.axisX2[e].crosshair.enabled&&this.axisX2[e].renderCrosshair(a,d);if(this.axisY&&0<this.axisY.length)for(e=0;e<this.axisY.length;e++)this.axisY[e].crosshair&&this.axisY[e].crosshair.enabled&&this.axisY[e].renderCrosshair(a,d);if(this.axisY2&&0<this.axisY2.length)for(e=0;e<this.axisY2.length;e++)this.axisY2[e].crosshair&&this.axisY2[e].crosshair.enabled&&this.axisY2[e].renderCrosshair(a,d)}};l.prototype._zoomPanToSelectedRegion=function(a,d,b,c,
...
n<q.minimum||f>q.maximum))u.push(q),r.push({val1:n,val2:f}),h=!0;else if(!e){h=!1;break}}return{isValid:h,axesWithValidRange:u,axesRanges:r}};l.prototype.preparePlotArea=function(){var a=this.plotArea;!s&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;if(this.axisY&&0<this.axisY.length&&this.axisY[0]){var b=this.axisY[0];a.x1=d.x1<d.x2?d.x1:b.lineCoordinates.x1;
...
c.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var y=k._colorSet,p=y=k.lineColor=k.options.lineColor?k.options.lineColor:y[0];b.strokeStyle=y;var l=!0,t=0,E,x;b.beginPath();if(0<r.length){for(var v=!1,t=0;t<r.length;t++)if(E=r[t].x.getTime?r[t].x.getTime():r[t].x,!(E<a.axisX.dataInfo.viewPortMin||E>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!v)))if("number"!==typeof r[t].y)0<t&&!(k.connectNullData||v||l)&&(b.stroke(),s&&c.stroke()),v=!0;else{E=a.axisX.convertValueToPixel(E);x=
a.axisY.convertValueToPixel(r[t].y);var A=k.dataPointIds[t];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:t,x1:E,y1:x};l||v?(!l&&k.connectNullData?(b.setLineDash&&(k.options.nullDataLineDashType||q===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(b.stroke(),b.beginPath(),b.moveTo(m.x,m.y),q=k.nullDataLineDashType,b.setLineDash(n)),b.lineTo(E,x),s&&c.lineTo(E,x)):(b.beginPath(),b.moveTo(E,x),s&&(c.beginPath(),c.moveTo(E,x))),v=l=!1):(b.lineTo(E,
...
b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(e.x1,e.y1,e.width,e.height),c.beginPath());b.restore();b.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||
this.plotArea.ctx,b=s?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx;b.save();var e=this.plotArea;b.beginPath();b.rect(e.x1,e.y1,e.width,e.height);b.clip();for(var g=[],m,h=0;h<a.dataSeriesIndexes.length;h++){var u=a.dataSeriesIndexes[h],k=this.data[u];b.lineWidth=k.lineThickness;var r=k.dataPoints,q="solid";if(b.setLineDash){var n=R(k.nullDataLineDashType,k.lineThickness),q=k.lineDashType,f=R(q,k.lineThickness);b.setLineDash(f)}var y=k.id;this._eventManager.objectMap[y]=
{objectType:"dataSeries",dataSeriesIndex:u};y=S(y);c.strokeStyle=y;c.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var y=k._colorSet,p=y=k.lineColor=k.options.lineColor?k.options.lineColor:y[0];b.strokeStyle=y;var l=!0,t=0,v,x;b.beginPath();if(0<r.length){for(var B=!1,t=0;t<r.length;t++)if(v=r[t].getTime?r[t].x.getTime():r[t].x,!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!B)))if("number"!==typeof r[t].y)0<t&&!(k.connectNullData||B||l)&&(b.stroke(),
s&&c.stroke()),B=!0;else{var A=x;v=a.axisX.convertValueToPixel(v);x=a.axisY.convertValueToPixel(r[t].y);var z=k.dataPointIds[t];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:t,x1:v,y1:x};l||B?(!l&&k.connectNullData?(b.setLineDash&&(k.options.nullDataLineDashType||q===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(b.stroke(),b.beginPath(),b.moveTo(m.x,m.y),q=k.nullDataLineDashType,b.setLineDash(n)),b.lineTo(v,A),b.lineTo(v,x),s&&(c.lineTo(v,
A),c.lineTo(v,x))):(b.beginPath(),b.moveTo(v,x),s&&(c.beginPath(),c.moveTo(v,x))),B=l=!1):(b.lineTo(v,A),s&&c.lineTo(v,A),b.lineTo(v,x),s&&c.lineTo(v,x),0==t%500&&(b.stroke(),b.beginPath(),b.moveTo(v,x),s&&(c.stroke(),c.beginPath(),c.moveTo(v,x))));m={x:v,y:x};t<r.length-1&&(p!==(r[t].lineColor||y)||q!==(r[t].lineDashType||k.lineDashType))&&(b.stroke(),b.beginPath(),b.moveTo(v,x),p=r[t].lineColor||y,b.strokeStyle=p,b.setLineDash&&(r[t].lineDashType?(q=r[t].lineDashType,b.setLineDash(R(q,k.lineThickness))):
...
return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};l.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,b=s?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var c=null,e=this.plotArea,g=[],m=[],h=[],u=[],k=0,r,q,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?
...
animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:n<a.axisY.bounds.y1?a.axisY.bounds.y1:n>a.axisY.bounds.y2?a.axisY.bounds.y2:n}}};l.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,b=s?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var c=null,e=this.plotArea,g=[],m=[],h=[],u=[],k=0,r,q,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:
...
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());b.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:n<a.axisY.bounds.x1?a.axisY.bounds.x1:n>a.axisY.bounds.x2?a.axisY.bounds.x2:n}}};l.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
...
0,0,this.width,this.height),g.clearRect(r.x1,r.y1,r.width,r.height),this._eventManager.ghostCtx.restore());g.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderStackedArea=function(a){function d(){if(!(1>u.length)){for(0<z.lineThickness&&c.stroke();0<u.length;){var a=u.pop();c.lineTo(a.x,a.y);s&&p.lineTo(a.x,a.y)}c.closePath();c.globalAlpha=z.fillOpacity;c.fill();c.globalAlpha=1;c.beginPath();s&&(p.closePath(),
...
c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(m.x1,m.y1,m.width,m.height),p.restore());c.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderStackedArea100=function(a){function d(){for(0<z.lineThickness&&c.stroke();0<u.length;){var a=u.pop();c.lineTo(a.x,a.y);s&&x.lineTo(a.x,
...
a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(c.x1,c.y1,c.width,c.height),this._eventManager.ghostCtx.restore());b.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderScatter=
...
b.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,b=s?this._preRenderCtx:d,c=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,g=null,m=this.plotArea,h=0,u,k,r,q,n,f,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,g=this.options.dataPointMaxWidth?
...
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());b.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderError=
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());b.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderRangeArea=function(a){function d(){if(w){var a=null;0<r.lineThickness&&c.stroke();for(var b=u.length-1;0<=b;b--)a=u[b],c.lineTo(a.x,a.y),e.lineTo(a.x,a.y);c.closePath();c.globalAlpha=r.fillOpacity;c.fill();c.globalAlpha=1;e.fill();if(0<r.lineThickness){c.beginPath();c.moveTo(a.x,
...
this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(m.x1,m.y1,m.width,m.height),this._eventManager.ghostCtx.restore());c.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
...
500),p(w.plotArea.ctx||w.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};l.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();l.prototype.cancelRequestAnimFrame=window.cancelAnimationFrame||window.webkitCancelRequestAnimationFrame||window.mozCancelRequestAnimationFrame||window.oCancelRequestAnimationFrame||
window.msCancelRequestAnimationFrame||clearTimeout;l.prototype.set=function(a,d,b){b="undefined"===typeof b?!0:b;"options"===a?(this.options=d,b&&this.render()):l.base.set.call(this,a,d,b)};l.prototype.exportChart=function(a){a="undefined"===typeof a?{}:a;var d=a.format?a.format:"png",b=a.fileName?a.fileName:this.exportFileName;if(a.toDataURL)return this.canvas.toDataURL("image/"+d);Sa(this.canvas,d,b)};l.prototype.print=function(){var a=this.exportChart({toDataURL:!0}),d=document.createElement("iframe");
...
n<=u?u=n:0<m?k++:r++;l<=p/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":p=la("markerSize",f,this)||4;s=b?20:p;l=Math.min(Math.sqrt(Math.pow(n.x1-a,2)+Math.pow(n.y1-d,2)),Math.sqrt(Math.pow(n.x1-a,2)+Math.pow(n.y2-d,2)));l<=s&&c.push({dataPoint:f,dataPointIndex:g,dataSeries:this,distance:l});n=Math.abs(n.x1-a);n<=u?u=n:0<m?k++:r++;l<=p/2&&(h=!0);break;case "bubble":p=n.size;l=Math.sqrt(Math.pow(n.x1-a,2)+Math.pow(n.y1-d,2));l<=p/2&&(c.push({dataPoint:f,dataPointIndex:g,dataSeries:this,distance:l}),
...
0;d<a.length;d++){var b=a[d];ka.drawMarker(b.x,b.y,b.ctx,b.type,b.size,b.color,b.borderColor,b.borderThickness)}}};return l}();Ma.Chart.version="v2.3 GA"})();
